...
[![Java](https://img.shields.io/badge/Java-8-orange)](https://github.com/easy-4-java/spring-security-extension2) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)

spring-security-extension2 ("Security Biz SDK") is the shared contract layer of the easy4j Spring Security ecosystem, independent of Spring Boot:
...
```groovy
implementation 'io.github.easy4j:spring-security-extension2:1.0.x.20260630-SNAPSHOT'
```
